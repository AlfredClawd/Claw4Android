...
public final class ItemMessageBinding implements ViewBinding {
  ...
  private ItemMessageBinding(@NonNull FrameLayout rootView, @NonNull MaterialCardView cardMessage,
      @NonNull TextView textMessage, @NonNull TextView textTimestamp) {
  ...
  public static ItemMessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMessageBinding((FrameLayout) rootView, cardMessage, textMessage,
          textTimestamp);
    }
